...
! ------------------------------------------------------------------------------
   ...
   real(r8), dimension(1 - nbdy:idm + nbdy,1 - nbdy:jdm + nbdy) :: &
#ifdef DCPP_HFX
      dcpphfx, &      ! DCPP imposed heat flux [W m-2]
      dcpphfx1, &     ! DCPP imposed heat flux [W m-2]
      dcpphfx2, &     ! DCPP imposed heat flux [W m-2]
      dcpphfx_weighted, & ! DCPP imposed heat flux [W m-2]
#endif 
#ifdef DCPP_TAU
      dcpptaux, &     ! DCPP imposed wind stress x-component [N m-2]
      dcpptaux1, &    ! DCPP imposed wind stress x-component [N m-2]
      dcpptaux2, &    ! DCPP imposed wind stress x-component [N m-2]
      dcpptauy, &     ! DCPP imposed wind stress y-component [N m-2]
      dcpptauy1, &    ! DCPP imposed wind stress y-component [N m-2]
      dcpptauy2, &    ! DCPP imposed wind stress y-component [N m-2]
      dcpptaux_weighted, & ! DCPP imposed wind stress x-component [N m-2]
      dcpptauy_weighted, & ! DCPP imposed wind stress y-component [N m-2]
#endif 
