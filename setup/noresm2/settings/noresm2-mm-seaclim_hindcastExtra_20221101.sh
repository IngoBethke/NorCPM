...
# experiment settings
: ${EXPERIMENT:=noresm2-mm-seaclim_hindcastExtra} # case prefix, not including _YYYYMMDD_memXX suffix 
: ${MEMBER1:=1} # first member  
: ${ENSSIZE:=10} # number of members 
: ${COMPSET:=NHISTfrc2}
: ${USER_MODS_DIR:=$SETUPROOT/user_mods/noresm2-mm-seaclim_hindcastExtra_256pes}   
: ${RES:=f09_tn14}
: ${START_DATE:=2022-11-01} # YYYY-MM-DD 
...
: ${REF_PATH_LOCAL:=/nird/datalake/NS9873K/norcpm/raw/noresm2/noresm2-mm_oda_20mem/noresm2-mm_oda_20mem_19811101}
