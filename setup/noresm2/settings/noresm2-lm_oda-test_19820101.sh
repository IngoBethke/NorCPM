...
# experiment settings
: ${EXPERIMENT:=noresm2-lm_oda-test} # case prefix, not including _YYYYMMDD_memXX suffix 
...
: ${RESTART:=13} # restart this many times  
: ${WALLTIME:='02:00:00'}
: ${ACCOUNT:=nn11071k}
...
: ${OBSLIST:='TEM SAL SST'}
: ${PRODUCERLIST:='CODC-v2 CODC-v2 MET'}
: ${FREQUENCYLIST:='MONTH MONTH MONTH'} 
: ${REF_PERIODLIST:='1982-2021 1982-2021 1982-2021'}
: ${COMBINE_ASSIM:='0 1 1'}
