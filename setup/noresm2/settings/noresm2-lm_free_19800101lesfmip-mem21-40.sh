...
# experiment settings
: ${EXPERIMENT:=NHISTfrc2_f19_tn14_LESFMIPhist-all} # case prefix, not including _YYYYMMDD_memXXX suffix 
: ${MEMBER1:=21} # first member  
